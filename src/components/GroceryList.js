...
function GroceryList() {
  ...
  const fetchDataByCategory = async (category) => {
    try {
      const response = await axios.get(`http://localhost:3001/getCategories/${category}`); // Replace with your API endpoint
  ...
  useEffect(() => {
    axios.get('http://localhost:3001/getCategories').then((result) => {
